...
public class AbtractPage {
	...
	public void swithToWindowHandleByTitle(WebDriver driver, String title) {
		...
		for (String runWindow : allWindow) {
			...
			if(curentWindow.endsWith(title)) {
				break;
			}
		}
	}
	...
	public void selectItemInDropdown(WebDriver driver, String Locator, String itemValue, String... values) { element = getElement(driver, getDynamicLocator(Locator, values));
		select = new Select(element);
		select.selectByVisibleText(itemValue);
	}
